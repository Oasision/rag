...
<template>
  <NCard :bordered="false" size="small" class="user-search-panel">
...
.user-search-panel :deep(.n-card__content) {
  padding: 7px 12px;
}

.user-search-panel :deep(.n-form) {
  align-items: center;
  gap: 8px 12px;
}

.user-search-panel :deep(.n-form-item) {
  margin-bottom: 0;
}

.user-search-panel :deep(.n-input),
.user-search-panel :deep(.n-base-selection) {
  min-height: 30px;
}
</style>
