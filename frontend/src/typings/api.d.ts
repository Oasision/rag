...
declare namespace Api {
  ...
  namespace InviteCode {
    ...
    interface RegistrationSettings {
      ...
      inviteGiftLlmTokens: number;
      inviteGiftEmbeddingTokens: number;
    }
  }
  ...
  namespace Admin {
    ...
    interface ModelProviderItem {
      ...
      maskedSecondaryApiKey: string;
      apiKeyInput?: string;
      secondaryApiKeyInput?: string;
    }

    interface ModelProviderScopeSettings {
      scope: 'llm' | 'embedding' | 'ocr' | 'vision_embedding' | 'multimodal_llm' | 'speech_transcription';
    ...
    interface ModelProviderSettings {
      ...
      ocr: ModelProviderScopeSettings;
      visionEmbedding: ModelProviderScopeSettings;
      multimodalLlm: ModelProviderScopeSettings;
      speechTranscription: ModelProviderScopeSettings;
    }
  ...
  namespace KnowledgeBase {
    ...
    interface SearchResult {
      ...
      retrievalMode?: 'HYBRID' | 'TEXT_ONLY' | 'IMAGE' | null;
    }
