              ...
              <div class="source-card-top">
                <div class="file-badge-shell">
                  ...
                  <div class="file-badge-copy">
                    <h2 class="preview-title" :title="fileName">{{ fileName }}</h2>
...
import { uploadIconExtensions } from '@/constants/common';
...
function getFileIcon(fileName: string) {
  ...
  if (ext) {
    ...
    return uploadIconExtensions.includes(normalizedExt) ? normalizedExt : 'dflt';
  }
  return 'dflt';
}
...
.file-preview-container {
  ...
  .preview-title {
    @apply m-0 line-clamp-3 text-[17px] font-700 leading-tight text-stone-800;
  ...
  .preview-content {
    ...
    .content-wrapper {
      @apply grid h-full min-h-0 grid-cols-[300px_minmax(0,1fr)] gap-3 overflow-hidden;
    }
